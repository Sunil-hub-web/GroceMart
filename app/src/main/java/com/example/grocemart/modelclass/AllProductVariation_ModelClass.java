...
public class AllProductVariation_ModelClass {

    String variation_Id,variation_unit,variation_mrpPrice,variation_salesPrice,variation_discount;

    public AllProductVariation_ModelClass(String variation_Id, String variation_unit,
                                          String variation_mrpPrice, String variation_salesPrice,
                                          String variation_discount) {
