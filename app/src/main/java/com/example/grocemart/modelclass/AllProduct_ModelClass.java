...
public class AllProduct_ModelClass {
    ...
    private ArrayList<AllProductVariation_ModelClass> variation;

    public AllProduct_ModelClass(String productId, String productName, String productDesc,
                                  ...
                                  ArrayList<AllProductVariation_ModelClass> variation) {
    ...
    public ArrayList<AllProductVariation_ModelClass> getVariation() {
        return variation;
    }

    public void setVariation(ArrayList<AllProductVariation_ModelClass> variation) {
        this.variation = variation;
    }
